                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text("Tài khoản", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20)),
                      const SizedBox(height: 16),
                      Container(
                          height: 80,
                                    ...
                                    builder: (context,AsyncSnapshot<bool> snapshot ){
                                      if(snapshot.hasData){
                                        return snapshot.data!
                                            ? Text("Thông tin tài khoản", style: TextStyle(fontWeight: FontWeight.w400, color: Colors.blue))
                                            : Text("Đăng nhập / Đăng kí", style: TextStyle(fontWeight: FontWeight.w400, color: Colors.blue));
                                      }
                                      else {
                      ...
                      SizedBox(height: 32),
                      Text("Cài đặt", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 20)),
                      SizedBox(height: 16),
