...
import 'package:store_app/models/chat/chat_message_model.dart';
...
class Body extends StatefulWidget {
  const Body({Key? key, required this.arguments}) : super(key: key);
...
class BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          /*this.widget.arguments.peerNickname*/"Admin",
          style: const TextStyle(color: ColorConstants.primaryColor),
        ),
        centerTitle: true,
      ),
