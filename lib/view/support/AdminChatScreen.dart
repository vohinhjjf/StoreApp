...
class AdminChatPage extends StatefulWidget {
  const AdminChatPage({Key? key, required this.arguments}) : super(key: key);

  final ChatPageArguments arguments;

  @override
  AdminChatPageState createState() => AdminChatPageState();
}

class AdminChatPageState extends State<AdminChatPage> {
